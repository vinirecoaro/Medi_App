            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <td className='border border-slate-300 text-center'>patient</td>
                    </tr>
                </thead>
                ...
                <tbody className="appointments" id="appointments">
                    {!!appointments && appointments.map((appointment: any) => (
                        <tr>
                            ...
                            <td className='border border-slate-300 text-center'><label>{ findPatientName(appointment.patientId) } </label></td>
