    ...
    return (
        <>
            <div>
                ...
                <Link className="font-medium text-blue-600 dark:text-blue-500 hover:underline" href="/patient/create">Create new patient</Link>
                <br></br>
                <Link className="font-medium text-blue-600 dark:text-blue-500 hover:underline" href="/patient/list">List all patients</Link>
                <br></br><br></br>
